...
El prompt de sistema MUST instruir al asistente a usar la fecha actual (vía la tool) para interpretar “hoy”, “mañana”, “esta semana” y referencias temporales similares, y MUST prohibir inventar la fecha.
