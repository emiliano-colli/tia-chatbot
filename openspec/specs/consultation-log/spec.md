...
Registro interno CSV de cada consulta cerrada, con ID entero correlativo, origen de canal y datos de contacto/interés. El UUID de sesión del browser o CLI no se reemplaza.
